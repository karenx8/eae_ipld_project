...
movies_df["duration"] = movies_df["duration"].str.extract(r'(\d+)').astype(int)
movies_filter = movies_df[movies_df["type"] == "Movie"]
movies_avg_duration_per_year = movies_filter.groupby("release_year")["duration"].mean()
