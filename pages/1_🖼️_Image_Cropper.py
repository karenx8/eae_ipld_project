...
min_height = 0 
max_height = img_arr.img_arr.shape[0]   # TODO: Replace None with the maximum height of the image using np.shape() function

min_width = 0
max_width = img_arr.img_arr.shape[1]    # TODO: Replace None with the maximum width of the image using np.shape() function   
